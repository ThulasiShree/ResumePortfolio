...
const SingleProject = ({ name, desc, align, image, link }) => {
  return (
    <motion.div
    ...
    >
      <div>
        ...
        <h2
          className={`text-sm font-thin text-white font-special sm:text-center ${
            align === "left" ? "md:text-justify" : "md:text-left"
          }`}
        >
          {desc}
        </h2>
